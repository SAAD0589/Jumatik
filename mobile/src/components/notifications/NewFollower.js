...
export function NewFollower(props) {
...
<Box w='100%' display='flex' justifyContent='center'  >
          ...
          <Flex direction='row' align="center">
            ...
            >
              Désolé, pas de notifications à l'horizon
            </Text>
          </Flex>
        </Box>
      </>
      ...
      {!deleted && 
        notifications.map(notification => (
         ...
         bg={notification?.read ? 'none' : unread}
            ...
            p={2}
          >
            <Flex  w="100%"  onClick={() => handleNotificationClick(notification._id)} key={notification._id} align="center"  >
              <Flex
                justify="center"
                align="center"
                borderRadius="16px"
              ...
              <Flex flexDirection="column">
                <Text
                  ...
                  fontSize={{ base: 'md', md: 'md' }}
                >
                  Alerte info : Nouveau fan en vue 
                </Text>
