...
export default function AuthNavbar(props) {
    ...
    const createNftsLinks = (routes) => {
        return routes.map((link, key) => {
            return ( <
                ...
                style = {
                    { maxWidth: "max-content", marginLeft: "40px" } } >
                <
                Text color = 'gray.400'
                fontSize = 'sm'
                fontWeight = 'normal' > { link.name } <
                /Text> <
                /NavLink>
            );
        });
        ...
        return routes.map((link, key) => {
            if (link.collapse === true) {
                return ( <
                    ...
                    bg = { menuBg } > { createMainLinks(link.items) } <
                    /Stack> <
                    /Stack>
                );
            } else {
        ...
        return routes.map((link, key) => {
            if (link.collapse === true) {
                return ( <
                    ...
                    /Stack> <
                    Stack direction = 'column'
                    bg = { menuBg } > { createAuthLinks(link.items) } <
                    /Stack> <
                    /Stack>
                );
            } else {
    ...
    const linksAuth = ( <
        ...
        Flex flexWrap = 'wrap'
        w = '300px'
        gap = '16px' > { createDashboardsLinks(dashboardsObject) } <
        /Flex> <
        /MenuList> <
        /Menu> <
        /Stack> <
        ...
        gap = '10px'
        minW = '500px'
        me = '20px' > { createAuthLinks(authObject) } <
        /SimpleGrid> {
            /* <Flex
                            bg='red'
                            direction='column'
        ...
        align = 'start'
        w = '500px'
        gap = '16px' > { createMainLinks(mainObject) } <
        /Flex> <
        /MenuList> <
        /Menu> <
        /Stack> <
        ...
        gap = '16px' > { createNftsLinks(nftsObject) } <
        /Grid> <
        /MenuList> <
        /Menu> <
        /Stack> <
    ...
    return ( <
        ...
        Flex w = '100%'
        justifyContent = {
            { sm: "start", lg: "space-between" } } > { brand } <
        Box ms = {
            { base: "auto", lg: "0px" } }
        display = {
            { base: "flex", lg: "none" } }
